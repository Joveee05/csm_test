...
})(
  {
    ...
    'alerts.js': [
      function (require, module, exports) {
        ...
        var showAlert = function showAlert(type, msg) {
          var time =
            arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
          hideAlert();
                    ...
                    while (1)
                      switch ((_context.prev = _context.next)) {
                        case 0:
                          ...
                          _context.next = 3;
                          return (0, _axios.default)(
                            '/api/users/checkout-session/'.concat(userId)
                          );
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var userDataForm = document.querySelector('.form-user-data'); // const bookBtn = document.getElementById('book-tour');

        console.log(document.getElementsByClassName('.heading-secondary'));
        if (loginForm)
